    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-2xl font-serif font-bold mb-4">ДОМСТРОЙ</h2>
            <p className="text-gray-300 mb-4">
              Премиальное строительство домов в Санкт-Петербурге и Ленинградской области с 2003 года.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <p>info@domstroy-spb.ru</p>
              </div>
              <div className="flex items-start">
                <MapPin size={16} className="mr-3 mt-1" />
                <p>г. Санкт-Петербург, ул. Большая Морская, 12, офис 150</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">Суббота: 10:00 - 15:00</p>
            <p>Воскресенье: выходной</p>
          </div>
        </div>
        
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ДОМСТРОЙ. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
